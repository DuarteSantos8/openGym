...
This project is indexed in codebase-memory-mcp as **"opengym"**. Use the graph tools
(`search_graph`, `trace_path`, `query_graph`, `get_code_snippet`, etc.) to explore the
codebase — they're faster and more precise than grep for structural queries.

```bash
# Re-index after major changes
# codebase-memory-mcp: index_repository(repo_path="/home/giulio/Desktop/opengym", name="opengym")
```
