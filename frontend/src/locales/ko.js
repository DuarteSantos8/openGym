...
export default {
  ...
  'Rest timer': '휴식 타이머',
  'Sounds': '소리',
  'Weight history keeps its numbers when units change. Body measurements are safely converted between cm and in.': '단위를 바꿔도 체중 기록의 숫자는 그대로예요. 신체 측정값은 cm와 in 사이에서 안전하게 변환돼요.',
  'Data': '데이터',
  'Export backup (JSON)': '백업 내보내기 (JSON)',
  'Import backup': '백업 가져오기',
  'Reset everything?': '전부 초기화할까요?',
  'Reset everything': '전부 초기화',
  'Deletes your plan, workouts, body weight and measurements on this device. This cannot be undone.': '이 기기의 계획, 운동, 체중, 측정값을 삭제합니다. 되돌릴 수 없어요.',
  ...
  'Measurements saved': '측정값을 저장했어요',
  'Measurements deleted': '측정값을 삭제했어요',
  'Delete measurements?': '측정값을 삭제할까요?',
  'Deletes the measurements logged on {0}.': '{0}에 기록한 측정값을 삭제해요.',
  'Log measurements': '측정값 기록',
  'Edit measurements': '측정값 편집',
  'Choose measurements': '측정 항목 선택',
  'Choose measurement': '측정 항목 선택',
  'Choose the measurements you want to track, then log your first check-in.': '추적할 항목을 고르고 첫 측정값을 기록해 보세요.',
  'Keep the logging form focused on the measurements you actually track.': '실제로 재는 항목만 입력 폼에 남겨 두세요.',
  'Fill only what you measured today. Empty fields stay empty.': '오늘 잰 것만 입력하세요. 빈 칸은 비워 둡니다.',
  'Choose at least one measurement first.': '먼저 항목을 하나 이상 선택하세요.',
  'Enter at least one measurement': '측정값을 하나 이상 입력하세요',
  'Choose a valid date': '올바른 날짜를 선택하세요',
  'That date already has measurements — edit it instead.': '그 날짜에는 이미 측정값이 있어요 — 기존 기록을 편집하세요.',
  'A custom measurement with that name already exists.': '같은 이름의 사용자 항목이 이미 있어요.',
  'Body fat must be between 0 and 100%.': '체지방률은 0에서 100 % 사이여야 해요.',
  'No measurements yet': '아직 측정값이 없어요',
  'No measurements yet — choose what you track and log your first check-in.': '아직 측정값이 없어요 — 추적할 항목을 고르고 첫 기록을 남겨 보세요.',
  'View measurements': '측정값 보기',
  'since previous': '이전 대비',
  '{0} measurement': '측정 {0}개',
  '{0} measurements': '측정 {0}개',
  'Custom measurement': '사용자 측정 항목',
  'Custom': '사용자',
  'Fields': '항목',
  'Date': '날짜',
  'Add': '추가',
  ...
  'Hips': '엉덩이',
  'Abdomen': '복부',
  'Left upper arm': '왼쪽 위팔',
  'Right upper arm': '오른쪽 위팔',
  'Left forearm': '왼쪽 아래팔',
  'Right forearm': '오른쪽 아래팔',
  'Left wrist': '왼쪽 손목',
  'Right wrist': '오른쪽 손목',
  'Left thigh': '왼쪽 허벅지',
  'Right thigh': '오른쪽 허벅지',
