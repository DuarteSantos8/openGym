...
export default {
  ...
  'Sounds': 'Sonidos',
  'Weight history keeps its numbers when units change. Body measurements are safely converted between cm and in.': 'El historial de peso conserva sus números al cambiar de unidad. Las medidas corporales se convierten con seguridad entre cm e in.',
  'Data': 'Datos',
  'Export backup (JSON)': 'Exportar copia (JSON)',
  'Import backup': 'Importar copia',
  'Reset everything?': '¿Restablecer todo?',
  'Reset everything': 'Restablecer todo',
  'Deletes your plan, workouts, body weight and measurements on this device. This cannot be undone.': 'Elimina tu plan, entrenamientos, peso corporal y medidas en este dispositivo. No se puede deshacer.',
  ...
  'Deletes the measurements logged on {0}.': 'Elimina las medidas registradas el {0}.',
  'Log measurements': 'Registrar medidas',
  'Edit measurements': 'Editar medidas',
  'Choose measurements': 'Elegir medidas',
  'Choose measurement': 'Elegir medida',
  'Choose the measurements you want to track, then log your first check-in.': 'Elige las medidas que quieres seguir y registra tu primera toma.',
  'Keep the logging form focused on the measurements you actually track.': 'Mantén el formulario centrado en las medidas que realmente sigues.',
  'Fill only what you measured today. Empty fields stay empty.': 'Rellena solo lo que mediste hoy. Los campos vacíos se quedan vacíos.',
  'Choose at least one measurement first.': 'Elige al menos una medida primero.',
  'Enter at least one measurement': 'Introduce al menos una medida',
  'Choose a valid date': 'Elige una fecha válida',
  'That date already has measurements — edit it instead.': 'Esa fecha ya tiene medidas — edítalas en su lugar.',
  'A custom measurement with that name already exists.': 'Ya existe una medida personalizada con ese nombre.',
  'Body fat must be between 0 and 100%.': 'La grasa corporal debe estar entre 0 y 100 %.',
  'No measurements yet': 'Aún no hay medidas',
  'No measurements yet — choose what you track and log your first check-in.': 'Aún no hay medidas — elige qué sigues y registra tu primera toma.',
  'View measurements': 'Ver medidas',
  'since previous': 'desde la anterior',
