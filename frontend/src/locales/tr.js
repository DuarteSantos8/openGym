...
export default {
  ...
  'The file does not say which unit it uses — numbers are imported as they are.': 'Dosya hangi birimi kullandığını söylemiyor — sayılar olduğu gibi aktarılır.'
}
