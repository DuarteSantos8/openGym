...
export default {
  ...
  'Sounds': 'Sesler',
  'Weight history keeps its numbers when units change. Body measurements are safely converted between cm and in.': 'Ağırlık geçmişi birim değişince sayılarını korur. Vücut ölçüleri cm ile in arasında güvenle dönüştürülür.',
  'Data': 'Veriler',
  ...
  'Deletes your plan, workouts, body weight and measurements on this device. This cannot be undone.': 'Bu cihazdaki planını, antrenmanlarını, vücut ağırlığını ve ölçülerini siler. Geri alınamaz.',
  ...
  'Measurement': 'Ölçü',
  'Measurement history': 'Ölçü geçmişi',
  'Measurements saved': 'Ölçüler kaydedildi',
  'Measurements deleted': 'Ölçüler silindi',
  'Delete measurements?': 'Ölçüler silinsin mi?',
  'Deletes the measurements logged on {0}.': '{0} tarihinde kaydedilen ölçüleri siler.',
  'Log measurements': 'Ölçü kaydet',
  'Edit measurements': 'Ölçüleri düzenle',
  'Choose measurements': 'Ölçüleri seç',
  'Choose measurement': 'Ölçü seç',
  'Choose the measurements you want to track, then log your first check-in.': 'Takip etmek istediğin ölçüleri seç, sonra ilk kaydını gir.',
  'Keep the logging form focused on the measurements you actually track.': 'Formu gerçekten takip ettiğin ölçülerle sınırlı tut.',
  'Fill only what you measured today. Empty fields stay empty.': 'Sadece bugün ölçtüklerini gir. Boş alanlar boş kalır.',
  'Choose at least one measurement first.': 'Önce en az bir ölçü seç.',
  'Enter at least one measurement': 'En az bir ölçü gir',
  'Choose a valid date': 'Geçerli bir tarih seç',
  'That date already has measurements — edit it instead.': 'Bu tarihte zaten ölçü var — onu düzenle.',
  'A custom measurement with that name already exists.': 'Bu adda özel bir ölçü zaten var.',
  'Body fat must be between 0 and 100%.': 'Vücut yağı %0 ile %100 arasında olmalı.',
  'No measurements yet': 'Henüz ölçü yok',
  'No measurements yet — choose what you track and log your first check-in.': 'Henüz ölçü yok — neyi takip ettiğini seç ve ilk kaydını gir.',
  'View measurements': 'Ölçüleri gör',
  'since previous': 'öncekine göre',
  '{0} measurement': '{0} ölçü',
  '{0} measurements': '{0} ölçü',
  'Custom measurement': 'Özel ölçü',
  'Custom': 'Özel',
  'Fields': 'Alanlar',
  'Date': 'Tarih',
  'Add': 'Ekle',
  ...
  'Hips': 'Kalça',
  'Abdomen': 'Karın',
  'Left upper arm': 'Sol üst kol',
  'Right upper arm': 'Sağ üst kol',
  'Left forearm': 'Sol ön kol',
  'Right forearm': 'Sağ ön kol',
  'Left wrist': 'Sol bilek',
  'Right wrist': 'Sağ bilek',
  'Left thigh': 'Sol uyluk',
  'Right thigh': 'Sağ uyluk',
  'Left calf': 'Sol baldır',
  'Right calf': 'Sağ baldır',
