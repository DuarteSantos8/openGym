...
export default {
  ...
  'Sounds': 'Töne',
  'Weight history keeps its numbers when units change. Body measurements are safely converted between cm and in.': 'Das Gewicht behält beim Einheitenwechsel seine Zahlen. Körpermaße werden sicher zwischen cm und in umgerechnet.',
  'Data': 'Daten',
  'Export backup (JSON)': 'Backup exportieren (JSON)',
  'Import backup': 'Backup importieren',
  'Reset everything?': 'Alles zurücksetzen?',
  'Reset everything': 'Alles zurücksetzen',
  'Deletes your plan, workouts, body weight and measurements on this device. This cannot be undone.': 'Löscht Plan, Trainings, Körpergewicht und Maße auf diesem Gerät. Das kann nicht rückgängig gemacht werden.',
  ...
  'Measurement': 'Maß',
  'Measurement history': 'Verlauf der Maße',
  'Measurements saved': 'Maße gespeichert',
  'Measurements deleted': 'Maße gelöscht',
  'Delete measurements?': 'Maße löschen?',
  'Deletes the measurements logged on {0}.': 'Löscht die am {0} eingetragenen Maße.',
  'Log measurements': 'Maße eintragen',
  'Edit measurements': 'Maße bearbeiten',
  'Choose measurements': 'Maße auswählen',
  'Choose measurement': 'Maß auswählen',
  'Choose the measurements you want to track, then log your first check-in.': 'Wähle die Maße, die du verfolgen willst, und trage deine ersten Werte ein.',
  'Keep the logging form focused on the measurements you actually track.': 'Halte das Formular auf die Maße beschränkt, die du wirklich verfolgst.',
  'Fill only what you measured today. Empty fields stay empty.': 'Trage nur ein, was du heute gemessen hast. Leere Felder bleiben leer.',
  'Choose at least one measurement first.': 'Wähle zuerst mindestens ein Maß aus.',
  'Enter at least one measurement': 'Trage mindestens ein Maß ein',
  'Choose a valid date': 'Wähle ein gültiges Datum',
  'That date already has measurements — edit it instead.': 'Für dieses Datum gibt es schon Maße — bearbeite sie stattdessen.',
  'A custom measurement with that name already exists.': 'Ein eigenes Maß mit diesem Namen gibt es schon.',
  'Body fat must be between 0 and 100%.': 'Körperfett muss zwischen 0 und 100 % liegen.',
  'No measurements yet': 'Noch keine Maße',
  'No measurements yet — choose what you track and log your first check-in.': 'Noch keine Maße — wähle aus, was du verfolgst, und trage deine ersten Werte ein.',
  'View measurements': 'Maße ansehen',
  'since previous': 'seit dem letzten Mal',
  '{0} measurement': '{0} Maß',
  '{0} measurements': '{0} Maße',
  'Custom measurement': 'Eigenes Maß',
  'Custom': 'Eigenes',
  'Fields': 'Felder',
  'Date': 'Datum',
  'Add': 'Hinzufügen',
  ...
  'Hips': 'Hüfte',
  'Abdomen': 'Bauch',
  'Left upper arm': 'Oberarm links',
  'Right upper arm': 'Oberarm rechts',
  'Left forearm': 'Unterarm links',
  'Right forearm': 'Unterarm rechts',
  'Left wrist': 'Handgelenk links',
  'Right wrist': 'Handgelenk rechts',
  'Left thigh': 'Oberschenkel links',
  'Right thigh': 'Oberschenkel rechts',
  'Left calf': 'Wade links',
  'Right calf': 'Wade rechts',
  'Left ankle': 'Knöchel links',
  'Right ankle': 'Knöchel rechts',
  'Body fat': 'Körperfett'
}
