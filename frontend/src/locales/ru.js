...
export default {
  ...
  'Sounds': 'Звуки',
  'Weight history keeps its numbers when units change. Body measurements are safely converted between cm and in.': 'История веса сохраняет свои числа при смене единиц. Замеры тела безопасно пересчитываются между см и дюймами.',
  'Data': 'Данные',
  'Export backup (JSON)': 'Экспорт резервной копии (JSON)',
  'Import backup': 'Импорт резервной копии',
  'Reset everything?': 'Сбросить всё?',
  'Reset everything': 'Сбросить всё',
  'Deletes your plan, workouts, body weight and measurements on this device. This cannot be undone.': 'Удаляет план, тренировки, вес тела и замеры на этом устройстве. Отменить нельзя.',
  ...
  'Measurements deleted': 'Замеры удалены',
  'Delete measurements?': 'Удалить замеры?',
  'Deletes the measurements logged on {0}.': 'Удаляет замеры, записанные {0}.',
  'Log measurements': 'Записать замеры',
  'Edit measurements': 'Изменить замеры',
  'Choose measurements': 'Выбрать замеры',
  'Choose measurement': 'Выбрать замер',
  'Choose the measurements you want to track, then log your first check-in.': 'Выбери замеры, которые хочешь отслеживать, и запиши первый.',
  'Keep the logging form focused on the measurements you actually track.': 'Оставь в форме только те замеры, которые действительно ведёшь.',
  'Fill only what you measured today. Empty fields stay empty.': 'Заполни только сегодняшние замеры. Пустые поля останутся пустыми.',
  'Choose at least one measurement first.': 'Сначала выбери хотя бы один замер.',
  'Enter at least one measurement': 'Введи хотя бы один замер',
  'Choose a valid date': 'Выбери корректную дату',
  'That date already has measurements — edit it instead.': 'На эту дату замеры уже есть — измени их.',
  'A custom measurement with that name already exists.': 'Свой замер с таким названием уже есть.',
  'Body fat must be between 0 and 100%.': 'Процент жира должен быть от 0 до 100 %.',
  'No measurements yet': 'Замеров пока нет',
  'No measurements yet — choose what you track and log your first check-in.': 'Замеров пока нет — выбери, что отслеживать, и запиши первый.',
  'View measurements': 'Открыть замеры',
  'since previous': 'с прошлого раза',
  '{0} measurement': '{0} замер',
  '{0} measurements': 'замеров: {0}',
  'Custom measurement': 'Свой замер',
  'Custom': 'Свой',
  'Fields': 'Поля',
  'Date': 'Дата',
  'Add': 'Добавить',
  ...
  'Hips': 'Таз',
  'Abdomen': 'Живот',
  'Left upper arm': 'Левый бицепс',
  'Right upper arm': 'Правый бицепс',
