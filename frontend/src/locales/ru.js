...
export default {
  ...
  'Add passkey on this device': 'Добавить ключ на это устройство',
  'Then this phone or computer can sign in as {0}.': 'Тогда этот телефон или компьютер сможет входить как {0}.',
  'Add another device': 'Добавить другое устройство',
  'Creates a 15-minute link. Open it on the new device, then create a passkey there.': 'Создаёт ссылку на 15 минут. Открой её на новом устройстве и создай там ключ.',
  'Copy link': 'Скопировать ссылку',
  'Copied': 'Скопировано',
  'This link expires in 15 minutes and works once.': 'Ссылка действует 15 минут и только один раз.',
  'Could not create a device link': 'Не удалось создать ссылку',
  '{0} passkey': 'ключей: {0}',
  '{0} passkeys': 'ключей: {0}',
  'Passkey added': 'Ключ добавлен',
  'Could not add a passkey': 'Не удалось добавить ключ',
  'Remove this passkey?': 'Удалить этот ключ?',
  'You cannot sign in with it afterwards. Keep at least one.': 'Им больше нельзя будет войти. Оставь хотя бы один.',
  'Passkey removed': 'Ключ удалён',
  'Could not remove passkey': 'Не удалось удалить ключ',
  'This device': 'Это устройство',
  'Added {0}': 'Добавлен {0}',
  'Welcome back — add a passkey on this device so you can sign in next time.': 'С возвращением — добавь ключ на это устройство, чтобы в следующий раз входить им.',
  'Link expired or already used': 'Ссылка истекла или уже использована',
  'Confirm with {0}. The passkey stays on this device — next time you sign in with it.': 'Подтверди через {0}. Ключ останется на этом устройстве — в следующий раз войдёшь им.',
}
