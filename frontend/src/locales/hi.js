...
export default {
  ...
  'Sounds': 'ध्वनियाँ',
  'Weight history keeps its numbers when units change. Body measurements are safely converted between cm and in.': 'इकाई बदलने पर वज़न इतिहास के आँकड़े वैसे ही रहते हैं। शरीर के माप cm और in के बीच सुरक्षित रूप से बदले जाते हैं।',
  'Data': 'डेटा',
  'Export backup (JSON)': 'बैकअप निर्यात करें (JSON)',
  'Import backup': 'बैकअप आयात करें',
  'Reset everything?': 'सब कुछ रीसेट करें?',
  'Reset everything': 'सब कुछ रीसेट करें',
  'Deletes your plan, workouts, body weight and measurements on this device. This cannot be undone.': 'इस डिवाइस पर आपकी योजना, वर्कआउट, वज़न और माप हट जाएँगे। इसे पूर्ववत नहीं किया जा सकता।',
  ...
  'Measurement': 'माप',
  'Measurement history': 'माप का इतिहास',
  'Measurements saved': 'माप सहेजे गए',
  'Measurements deleted': 'माप हटाए गए',
  'Delete measurements?': 'माप हटाएँ?',
  'Deletes the measurements logged on {0}.': '{0} को दर्ज किए गए माप हटा देता है।',
  'Log measurements': 'माप दर्ज करें',
  'Edit measurements': 'माप संपादित करें',
  'Choose measurements': 'माप चुनें',
  'Choose measurement': 'माप चुनें',
  'Choose the measurements you want to track, then log your first check-in.': 'जिन मापों को ट्रैक करना है उन्हें चुनें, फिर अपना पहला माप दर्ज करें।',
  'Keep the logging form focused on the measurements you actually track.': 'फ़ॉर्म में सिर्फ़ वही माप रखें जिन्हें आप वाकई ट्रैक करते हैं।',
  'Fill only what you measured today. Empty fields stay empty.': 'आज जो मापा है वही भरें। खाली फ़ील्ड खाली रहते हैं।',
  'Choose at least one measurement first.': 'पहले कम से कम एक माप चुनें।',
  'Enter at least one measurement': 'कम से कम एक माप दर्ज करें',
  'Choose a valid date': 'मान्य तारीख़ चुनें',
  'That date already has measurements — edit it instead.': 'उस तारीख़ के माप पहले से हैं — उन्हीं को संपादित करें।',
  'A custom measurement with that name already exists.': 'इस नाम का कस्टम माप पहले से मौजूद है।',
  'Body fat must be between 0 and 100%.': 'बॉडी फैट 0 से 100 % के बीच होना चाहिए।',
  'No measurements yet': 'अभी कोई माप नहीं',
  'No measurements yet — choose what you track and log your first check-in.': 'अभी कोई माप नहीं — चुनें कि क्या ट्रैक करना है और पहला माप दर्ज करें।',
  'View measurements': 'माप देखें',
  'since previous': 'पिछली बार से',
  '{0} measurement': '{0} माप',
  '{0} measurements': '{0} माप',
  'Custom measurement': 'कस्टम माप',
  'Custom': 'कस्टम',
  'Fields': 'फ़ील्ड',
  'Date': 'तारीख़',
  'Add': 'जोड़ें',
  ...
  'Hips': 'कूल्हे',
  'Abdomen': 'पेट',
  'Left upper arm': 'बाईं बाँह',
  'Right upper arm': 'दाईं बाँह',
  'Left forearm': 'बाईं अग्रभुजा',
  'Right forearm': 'दाईं अग्रभुजा',
  'Left wrist': 'बाईं कलाई',
  'Right wrist': 'दाईं कलाई',
  'Left thigh': 'बाईं जाँघ',
  'Right thigh': 'दाईं जाँघ',
  'Left calf': 'बाईं पिंडली',
  'Right calf': 'दाईं पिंडली',
  'Left ankle': 'बायाँ टखना',
  'Right ankle': 'दायाँ टखना',
  'Body fat': 'बॉडी फैट'
}
