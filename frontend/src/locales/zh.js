...
export default {
  ...
  'Rest timer': '休息计时',
  'Sounds': '声音',
  'Weight history keeps its numbers when units change. Body measurements are safely converted between cm and in.': '切换单位时体重记录的数字保持不变；身体围度会在 cm 与 in 之间安全换算。',
  'Data': '数据',
  'Export backup (JSON)': '导出备份（JSON）',
  'Import backup': '导入备份',
  'Reset everything?': '重置所有内容？',
  'Reset everything': '重置所有内容',
  'Deletes your plan, workouts, body weight and measurements on this device. This cannot be undone.': '删除本设备上的计划、训练、体重和围度记录。无法撤销。',
  ...
  'Measurements saved': '已保存测量',
  'Measurements deleted': '已删除测量',
  'Delete measurements?': '删除这次测量？',
  'Deletes the measurements logged on {0}.': '删除 {0} 记录的测量。',
  'Log measurements': '记录测量',
  'Edit measurements': '编辑测量',
  'Choose measurements': '选择测量项',
  'Choose measurement': '选择测量项',
  'Choose the measurements you want to track, then log your first check-in.': '选择你想跟踪的测量项，然后记录第一次测量。',
  'Keep the logging form focused on the measurements you actually track.': '让表单只保留你真正跟踪的测量项。',
  'Fill only what you measured today. Empty fields stay empty.': '只填今天量过的部位，留空的字段保持为空。',
  'Choose at least one measurement first.': '请先选择至少一个测量项。',
  'Enter at least one measurement': '请至少输入一项测量',
  'Choose a valid date': '请选择有效日期',
  'That date already has measurements — edit it instead.': '该日期已有测量——请直接编辑。',
  'A custom measurement with that name already exists.': '已有同名的自定义测量项。',
  'Body fat must be between 0 and 100%.': '体脂率必须在 0% 到 100% 之间。',
  'No measurements yet': '还没有测量',
  'No measurements yet — choose what you track and log your first check-in.': '还没有测量——选择你要跟踪的项目并记录第一次。',
  'View measurements': '查看测量',
  'since previous': '较上次',
  '{0} measurement': '{0} 项测量',
  '{0} measurements': '{0} 项测量',
  'Custom measurement': '自定义测量项',
  'Custom': '自定义',
  'Fields': '字段',
  'Date': '日期',
  'Add': '添加',
